...
import { Save, Server, Shield, Moon, Sun } from 'lucide-react';
  ...
  return (
    <div className="flex-1 p-8 space-y-8 bg-background relative min-h-screen">
      ...
      <div className="flex justify-between items-end relative z-10">
        ...
        <Button className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-none"><Save className="w-4 h-4 mr-2" /> Save Changes</Button>
      </div>
        ...
        <Card className="border-border bg-card shadow-none">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="https://goa-hackathon.i.tgcloud.io" className="w-full bg-input border border-border rounded-md px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary" />
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground mb-1">Graph Name</label>
              <input type="text" defaultValue="AntiFraud" className="w-full bg-input border border-border rounded-md px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary" />
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-bold text-destructive">80%</span>
                </div>
                <input type="range" min="0" max="100" defaultValue="80" className="w-full accent-destructive" />
